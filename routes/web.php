...
use App\Http\Livewire\AgriInputListComponent;
use App\Http\Livewire\AgriInputsComponent;
use App\Http\Livewire\BlogDetailsComponent;
use App\Http\Livewire\BlogsComponent;
use App\Http\Livewire\CartComponent;
use App\Http\Livewire\Category2Component;
...
Route::get('/products-list', ProductListComponent::class)->name('products-list');
Route::get('/agri-inputs', AgriInputsComponent::class)->name('inputs');
Route::get('/agri-inputs-list', AgriInputListComponent::class)->name('inputs-list');
...
Route::get('/agi-input-category/{category_slug}', Category2Component::class)->name('product.category2');
