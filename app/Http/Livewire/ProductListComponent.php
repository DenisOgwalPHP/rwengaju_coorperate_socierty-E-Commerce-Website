...
{public $sorting;
    ...
    public function render()
    {
        ...
        return view('livewire.product-list-component', ['products' => $products, 'categories' => $categories, 'lproducts' =>$lproducts, 'popular_products'=> $popular_products])->layout('layouts.base');
    }
}