                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="#">Products Grid</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="shop-sidebar">
                            ...
                            <div class="single-widget category">
                                ...
                                <ul class="categor-list">
                                    ...
                                    <li><a href="{{ route('product.category2', ['category_slug' => $category->slug]) }}">{{ $category->name }}</a></li>
                            ...
                            <div class="shop-top wrap-shop-control" >
                                {{-- <div class="shop-shorter">
                                    <div class="single-shorter">
                                        <label>Show :</label>
                                        <select wire:model="pagesize" style="display: block;" >
                                    ...
                                    <div class="single-shorter">
                                        <label>Sort By :</label>
                                        <select  wire:model="sorting" style="display: none;" >
                                ...
                                <ul class="view-mode">
                                    ...
                                    <li><a href="{{ route('inputs-list') }}"><i class="fa fa-th-list"></i></a></li>
                                </ul>
                            </div>
                            <!--/ End Shop Top -->
                        </div>
                            ...
                            <div class="single-product">
                                <div class="product-img">
                                    <a href="{{ route('product.details', ['slug' => $product->slug]) }}">
                                        <img class="default-img" style="height: 250px;" src="{{ asset('images/products') }}/{{ $product->image }}" alt="#">
                                        <img class="hover-img" style="height: 250px;" src="{{ asset('images/products') }}/{{ $product->image }}" alt="#">
                                    </a>
                                ...
                                <div class="product-content">
                                    ...
                                    <div class="product-price">
                                        <span>USh{{  $product->regular_price }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
